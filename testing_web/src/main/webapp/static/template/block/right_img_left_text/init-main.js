define("./make.tpl.html", [ "require", "exports", "module" ], function(require, exports, module) {
    ...
    exports.render = function($data, $opt) {
        ...
        (function() {
            with ($data) {
                _$out_.push('<table style="width:100%"><tr><td style="width: 100%"><div contenteditable="true" data-setter="setTxt">', txt, '</div></td><td align="center"><div class="dropImage" style="width:300px;" data-setter="setImg">');
                if (img) {
...
define("./view.tpl.html", [ "require", "exports", "module" ], function(require, exports, module) {
    ...
    exports.render = function($data, $opt) {
        ...
        (function() {
            with ($data) {
                _$out_.push('<table style="width:100%"><tr>');
                if (img) {
                    _$out_.push('<td align="center"><div class="dropImage">', img, "</div></td>");
                }
                _$out_.push('<td style="width: 100%">', txt, "</td></tr></table>");
            }
        })();
        return _$out_.join("");
    };
